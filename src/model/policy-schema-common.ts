...
export interface PolicySchemaCommon {
    ...
    /**
     * The review date timestamp for the policy (in seconds). The review date is mandatory if configured to be in Invotra admin.
     * @type {number}
     * @memberof PolicySchemaCommon
     */
...
/**
    ...
    * @enum {string}
    */
export enum PolicySchemaCommonStateEnum {
    Draft = 'draft',
