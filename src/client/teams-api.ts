...
export const TeamsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        teamsListGet(label?: string, autocomplete?: string, users_fulltext_search?: string, external_id?: string, offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const TeamsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        teamsListGet(label?: string, autocomplete?: string, users_fulltext_search?: string, external_id?: string, offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse200> {
            const localVarAxiosArgs = TeamsApiAxiosParamCreator(configuration).teamsListGet(label, autocomplete, users_fulltext_search, external_id, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const TeamsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        teamsListGet(label?: string, autocomplete?: string, users_fulltext_search?: string, external_id?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse200> {
            return TeamsApiFp(configuration).teamsListGet(label, autocomplete, users_fulltext_search, external_id, offset, limit, options)(axios, basePath);
        },
        /**
         * Provision a new team.
         * @param {TeamSchemaCreate} TeamSchemaCreate 
...
export class TeamsApi extends BaseAPI implements TeamsApiInterface {
     ...
     * @memberof TeamsApi
     */
    public teamsListGet(label?: string, autocomplete?: string, users_fulltext_search?: string, external_id?: string, offset?: number, limit?: number, options?: any) {
        return TeamsApiFp(this.configuration).teamsListGet(label, autocomplete, users_fulltext_search, external_id, offset, limit, options)(this.axios, this.basePath);
    }
