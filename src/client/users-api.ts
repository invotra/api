...
export const UsersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersSearchGet(fulltext_search?: string, team?: string, location?: string, group?: string, external_id?: string, sort?: 'firstname' | 'surname' | 'updated' | 'relevance', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const UsersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersSearchGet(fulltext_search?: string, team?: string, location?: string, group?: string, external_id?: string, sort?: 'firstname' | 'surname' | 'updated' | 'relevance', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2002> {
            const localVarAxiosArgs = UsersApiAxiosParamCreator(configuration).usersSearchGet(fulltext_search, team, location, group, external_id, sort, order, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const UsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersSearchGet(fulltext_search?: string, team?: string, location?: string, group?: string, external_id?: string, sort?: 'firstname' | 'surname' | 'updated' | 'relevance', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse2002> {
...
export class UsersApi extends BaseAPI implements UsersApiInterface {
     ...
     * @memberof UsersApi
     */
    public usersSearchGet(fulltext_search?: string, team?: string, location?: string, group?: string, external_id?: string, sort?: 'firstname' | 'surname' | 'updated' | 'relevance', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
