...
export const PromotionsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        promotionsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const PromotionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        promotionsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20024> {
            const localVarAxiosArgs = PromotionsApiAxiosParamCreator(configuration).promotionsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
export const PromotionsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        promotionsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20024> {
...
export class PromotionsApi extends BaseAPI implements PromotionsApiInterface {
     ...
     */
    public promotionsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
