...
export const LocationsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        locationsListGet(title?: string, autocomplete?: string, external_id?: string, users_fulltext_search?: string, offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const LocationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        locationsListGet(title?: string, autocomplete?: string, external_id?: string, users_fulltext_search?: string, offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20029> {
            const localVarAxiosArgs = LocationsApiAxiosParamCreator(configuration).locationsListGet(title, autocomplete, external_id, users_fulltext_search, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const LocationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        locationsListGet(title?: string, autocomplete?: string, external_id?: string, users_fulltext_search?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20029> {
            return LocationsApiFp(configuration).locationsListGet(title, autocomplete, external_id, users_fulltext_search, offset, limit, options)(axios, basePath);
        },
        /**
         * Remove location information
         * @param {string} location_id The Invotra UUID of the location.
...
export class LocationsApi extends BaseAPI implements LocationsApiInterface {
     ...
     * @memberof LocationsApi
     */
    public locationsListGet(title?: string, autocomplete?: string, external_id?: string, users_fulltext_search?: string, offset?: number, limit?: number, options?: any) {
        return LocationsApiFp(this.configuration).locationsListGet(title, autocomplete, external_id, users_fulltext_search, offset, limit, options)(this.axios, this.basePath);
    }
