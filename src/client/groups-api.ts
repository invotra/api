...
export const GroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, sort?: 'relevance' | 'likes' | 'members_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const GroupsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, sort?: 'relevance' | 'likes' | 'members_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010> {
...
export class GroupsApi extends BaseAPI implements GroupsApiInterface {
     ...
     * @memberof GroupsApi
     */
    public groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, sort?: 'relevance' | 'likes' | 'members_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
