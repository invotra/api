...
export const GroupsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, external_id?: string, sort?: 'relevance' | 'likes' | 'members_count' | 'timestamp_created', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const GroupsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, external_id?: string, sort?: 'relevance' | 'likes' | 'members_count' | 'timestamp_created', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20010> {
            const localVarAxiosArgs = GroupsApiAxiosParamCreator(configuration).groupsSearchGet(fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const GroupsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, external_id?: string, sort?: 'relevance' | 'likes' | 'members_count' | 'timestamp_created', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20010> {
            return GroupsApiFp(configuration).groupsSearchGet(fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options)(axios, basePath);
        },
    };
};
...
export class GroupsApi extends BaseAPI implements GroupsApiInterface {
     ...
     * @memberof GroupsApi
     */
    public groupsSearchGet(fulltext_search?: string, category?: string, my_groups?: boolean, external_id?: string, sort?: 'relevance' | 'likes' | 'members_count' | 'timestamp_created', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
        return GroupsApiFp(this.configuration).groupsSearchGet(fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options)(this.axios, this.basePath);
    }
