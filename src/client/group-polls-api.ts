...
export const GroupPollsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupPollsListGet(author_uuid?: string, group_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const GroupPollsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupPollsListGet(author_uuid?: string, group_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20017> {
            const localVarAxiosArgs = GroupPollsApiAxiosParamCreator(configuration).groupPollsListGet(author_uuid, group_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export class GroupPollsApi extends BaseAPI implements GroupPollsApiInterface {
     ...
     * @memberof GroupPollsApi
     */
    public groupPollsListGet(author_uuid?: string, group_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
