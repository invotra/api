...
export const PoliciesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        policiesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const PoliciesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        policiesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20022> {
            const localVarAxiosArgs = PoliciesApiAxiosParamCreator(configuration).policiesListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
export const PoliciesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        policiesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20022> {
...
export class PoliciesApi extends BaseAPI implements PoliciesApiInterface {
     ...
     */
    public policiesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
