...
export const ManualsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        manualsGet(external_id?: string, offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const ManualsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        manualsGet(external_id?: string, offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20025> {
            const localVarAxiosArgs = ManualsApiAxiosParamCreator(configuration).manualsGet(external_id, offset, limit, options);
...
export const ManualsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        manualsGet(external_id?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20025> {
...
export class ManualsApi extends BaseAPI implements ManualsApiInterface {
     ...
     * @memberof ManualsApi
     */
    public manualsGet(external_id?: string, offset?: number, limit?: number, options?: any) {
