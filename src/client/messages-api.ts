...
export const MessagesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        messagesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const MessagesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        messagesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20019> {
            const localVarAxiosArgs = MessagesApiAxiosParamCreator(configuration).messagesListGet(author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options);
...
export class MessagesApi extends BaseAPI implements MessagesApiInterface {
     ...
     */
    public messagesListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
