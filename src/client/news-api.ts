...
export const NewsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        newsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const NewsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        newsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20020> {
            const localVarAxiosArgs = NewsApiAxiosParamCreator(configuration).newsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
export class NewsApi extends BaseAPI implements NewsApiInterface {
     ...
     * @memberof NewsApi
     */
    public newsListGet(author_uuid?: string, created_date?: string, updated_date?: string, external_id?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
