...
export const PostsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsListGet(external_id?: string, sort?: 'timestamp' | 'comment_count' | 'likes_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options: any = {}): RequestArgs {
...
export const PostsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsListGet(external_id?: string, sort?: 'timestamp' | 'comment_count' | 'likes_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20014> {
            const localVarAxiosArgs = PostsApiAxiosParamCreator(configuration).postsListGet(external_id, sort, order, offset, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const PostsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsListGet(external_id?: string, sort?: 'timestamp' | 'comment_count' | 'likes_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20014> {
            return PostsApiFp(configuration).postsListGet(external_id, sort, order, offset, limit, options)(axios, basePath);
        },
        /**
         * Create a post.
         * @param {PostSchemaCreate} PostSchemaCreate 
...
export class PostsApi extends BaseAPI implements PostsApiInterface {
     ...
     * @memberof PostsApi
     */
    public postsListGet(external_id?: string, sort?: 'timestamp' | 'comment_count' | 'likes_count', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any) {
        return PostsApiFp(this.configuration).postsListGet(external_id, sort, order, offset, limit, options)(this.axios, this.basePath);
    }
