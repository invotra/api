...
export declare const ManualsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    manualsGet(offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20024>;
    /**
     * Get a manual page, including the root manual page
     * @param {string} manual_page_id The Invotra UUID of a manual page.
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    manualsPagesGet(cursor?: string | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20025>;
};
/**
...
export declare const ManualsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    manualsGet(offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20024>;
    /**
     * Get a manual page, including the root manual page
     * @param {string} manual_page_id The Invotra UUID of a manual page.
     * @param {*} [options] Override http request option.
     ...
     * @throws {RequiredError}
     */
    manualsPagesGet(cursor?: string | undefined, options?: any): AxiosPromise<InlineResponse20025>;
};
/**
...
export interface ManualsApiInterface {
     ...
     */
    manualsGet(offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20024>;
    /**
     * Get a manual page, including the root manual page
     * @param {string} manual_page_id The Invotra UUID of a manual page.
     * @param {*} [options] Override http request option.
     ...
     * @memberof ManualsApiInterface
     */
    manualsPagesGet(cursor?: string, options?: any): AxiosPromise<InlineResponse20025>;
}
/**
