...
export var UsersApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        usersSearchGet: function (fulltext_search, team, location, group, external_id, sort, order, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var UsersApiFp = function (configuration) {
    return {
         ...
         */
        usersSearchGet: function (fulltext_search, team, location, group, external_id, sort, order, offset, limit, options) {
            var localVarAxiosArgs = UsersApiAxiosParamCreator(configuration).usersSearchGet(fulltext_search, team, location, group, external_id, sort, order, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
export var UsersApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        usersSearchGet: function (fulltext_search, team, location, group, external_id, sort, order, offset, limit, options) {
            return UsersApiFp(configuration).usersSearchGet(fulltext_search, team, location, group, external_id, sort, order, offset, limit, options)(axios, basePath);
        },
        /**
         * Return the user\'s activity feed.
         * @param {string} user_id The Invotra UUID of the user.
...
var UsersApi = /** @class */ (function (_super) {
     ...
     * @memberof UsersApi
     */
    UsersApi.prototype.usersSearchGet = function (fulltext_search, team, location, group, external_id, sort, order, offset, limit, options) {
        return UsersApiFp(this.configuration).usersSearchGet(fulltext_search, team, location, group, external_id, sort, order, offset, limit, options)(this.axios, this.basePath);
    };
    /**
     * Return the user\'s activity feed.
     * @param {string} user_id The Invotra UUID of the user.
