...
export var PostsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        postsListGet: function (external_id, sort, order, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var PostsApiFp = function (configuration) {
    return {
         ...
         */
        postsListGet: function (external_id, sort, order, offset, limit, options) {
            var localVarAxiosArgs = PostsApiAxiosParamCreator(configuration).postsListGet(external_id, sort, order, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
var PostsApi = /** @class */ (function (_super) {
     ...
     * @memberof PostsApi
     */
    PostsApi.prototype.postsListGet = function (external_id, sort, order, offset, limit, options) {
