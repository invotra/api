...
export declare const OrganisationalSkillsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    organisationalSkillsListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20042>;
    /**
     * Delete an organisational skill.
     * @param {string} organisational_skill_id The Invotra UUID of the organisational skill.
     * @param {*} [options] Override http request option.
...
export declare const OrganisationalSkillsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    organisationalSkillsListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20042>;
    /**
     * Delete an organisational skill.
     * @param {string} organisational_skill_id The Invotra UUID of the organisational skill.
     * @param {*} [options] Override http request option.
...
export interface OrganisationalSkillsApiInterface {
     ...
     */
    organisationalSkillsListGet(name?: string, external_id?: string, status?: string, valid_parents_for?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20042>;
    /**
     * Delete an organisational skill.
     * @param {string} organisational_skill_id The Invotra UUID of the organisational skill.
     * @param {*} [options] Override http request option.
