...
export var MessagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        messagesListGet: function (author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options) {
            ...
            if (configuration && configuration.accessToken) {
                var localVarAccessTokenValue = typeof configuration.accessToken === 'function'
                    ? configuration.accessToken("CognitoJwt", ["invotra/messages:read"])
        ...
        messagesMessageIdDelete: function (message_id, options) {
            ...
            if (configuration && configuration.accessToken) {
                var localVarAccessTokenValue = typeof configuration.accessToken === 'function'
                    ? configuration.accessToken("CognitoJwt", ["invotra/messages:write"])
                    : configuration.accessToken;
                localVarHeaderParameter["Authorization"] = "Bearer " + localVarAccessTokenValue;
            }
            // authentication SessionCookieHeader required
...
export var MessagesApiFp = function (configuration) {
    return {
         ...
         */
        messagesListGet: function (author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options) {
            var localVarAxiosArgs = MessagesApiAxiosParamCreator(configuration).messagesListGet(author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options);
...
export var MessagesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        messagesListGet: function (author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options) {
            return MessagesApiFp(configuration).messagesListGet(author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options)(axios, basePath);
        },
        /**
         * Delete a message.
         * @param {string} message_id The Invotra UUID of the message.
...
var MessagesApi = /** @class */ (function (_super) {
     ...
     */
    MessagesApi.prototype.messagesListGet = function (author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options) {
        return MessagesApiFp(this.configuration).messagesListGet(author_uuid, created_date, updated_date, external_id, sort, order, offset, limit, options)(this.axios, this.basePath);
    };
    /**
     * Delete a message.
     * @param {string} message_id The Invotra UUID of the message.
