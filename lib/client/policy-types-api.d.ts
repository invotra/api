...
export declare const PolicyTypesApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    policyTypesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20044>;
    /**
     * Delete a policy type.
     * @param {string} policy_type_id The Invotra UUID of the policy type.
     * @param {*} [options] Override http request option.
...
export declare const PolicyTypesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    policyTypesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20044>;
    /**
     * Delete a policy type.
     * @param {string} policy_type_id The Invotra UUID of the policy type.
     * @param {*} [options] Override http request option.
...
export interface PolicyTypesApiInterface {
     ...
     */
    policyTypesListGet(name?: string, external_id?: string, status?: string, valid_parents_for?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20044>;
    /**
     * Delete a policy type.
     * @param {string} policy_type_id The Invotra UUID of the policy type.
     * @param {*} [options] Override http request option.
