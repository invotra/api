 ...
 * @export
 */
export var EventTopicsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        eventTopicsEventTopicIdDelete: function (event_topic_id, options) {
            ...
            var localVarPath = "/event_topics/{event_topic_id}"
         ...
         * @throws {RequiredError}
         */
        eventTopicsEventTopicIdGet: function (event_topic_id, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'event_topic_id' is not null or undefined
            if (event_topic_id === null || event_topic_id === undefined) {
         ...
         * @throws {RequiredError}
         */
        eventTopicsEventTopicIdPut: function (event_topic_id, EventTopicSchemaCommon, options) {
            if (options === void 0) { options = {}; }
            // verify required parameter 'event_topic_id' is not null or undefined
            if (event_topic_id === null || event_topic_id === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof EventTopicSchemaCommon !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
         ...
         * @param {string} [status] Filter the list of event topics on a comma-separated list of statuses. Valid statuses are \&quot;published\&quot; and \&quot;unpublished\&quot;. You may include both. The default when not supplied is \&quot;published\&quot; only.
         ...
         * @throws {RequiredError}
         */
        eventTopicsListGet: function (name, external_id, status, valid_parents_for, offset, limit, options) {
            if (options === void 0) { options = {}; }
            var localVarPath = "/event_topics/list";
            var localVarUrlObj = globalImportUrl.parse(localVarPath, true);
            var baseOptions;
            if (configuration) {
                baseOptions = configuration.baseOptions;
         ...
         * @throws {RequiredError}
         */
        eventTopicsPost: function (EventTopicSchemaCreate, options) {
            if (options === void 0) { options = {}; }
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = __assign(__assign({}, localVarHeaderParameter), options.headers);
            var needsSerialization = (typeof EventTopicSchemaCreate !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
 ...
 * @export
 */
export var EventTopicsApiFp = function (configuration) {
    return {
        /**
         * Delete an event topic.
         * @param {string} event_topic_id The Invotra UUID of the event topic.
         ...
         */
        eventTopicsEventTopicIdDelete: function (event_topic_id, options) {
            var localVarAxiosArgs = EventTopicsApiAxiosParamCreator(configuration).eventTopicsEventTopicIdDelete(event_topic_id, options);
         ...
         */
        eventTopicsEventTopicIdGet: function (event_topic_id, options) {
            var localVarAxiosArgs = EventTopicsApiAxiosParamCreator(configuration).eventTopicsEventTopicIdGet(event_topic_id, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        eventTopicsEventTopicIdPut: function (event_topic_id, EventTopicSchemaCommon, options) {
            var localVarAxiosArgs = EventTopicsApiAxiosParamCreator(configuration).eventTopicsEventTopicIdPut(event_topic_id, EventTopicSchemaCommon, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        eventTopicsListGet: function (name, external_id, status, valid_parents_for, offset, limit, options) {
            var localVarAxiosArgs = EventTopicsApiAxiosParamCreator(configuration).eventTopicsListGet(name, external_id, status, valid_parents_for, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
         ...
         */
        eventTopicsPost: function (EventTopicSchemaCreate, options) {
            var localVarAxiosArgs = EventTopicsApiAxiosParamCreator(configuration).eventTopicsPost(EventTopicSchemaCreate, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
 ...
 * @export
 */
export var EventTopicsApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * Delete an event topic.
         * @param {string} event_topic_id The Invotra UUID of the event topic.
 ...
 * @extends {BaseAPI}
 */
var EventTopicsApi = /** @class */ (function (_super) {
    __extends(EventTopicsApi, _super);
    function EventTopicsApi() {
     ...
     */
    EventTopicsApi.prototype.eventTopicsEventTopicIdDelete = function (event_topic_id, options) {
     ...
     * @memberof EventTopicsApi
     */
    EventTopicsApi.prototype.eventTopicsEventTopicIdGet = function (event_topic_id, options) {
     ...
     * @memberof EventTopicsApi
     */
    EventTopicsApi.prototype.eventTopicsEventTopicIdPut = function (event_topic_id, EventTopicSchemaCommon, options) {
     ...
     * @memberof EventTopicsApi
     */
    EventTopicsApi.prototype.eventTopicsListGet = function (name, external_id, status, valid_parents_for, offset, limit, options) {
     ...
     * @memberof EventTopicsApi
     */
    EventTopicsApi.prototype.eventTopicsPost = function (EventTopicSchemaCreate, options) {
        return EventTopicsApiFp(this.configuration).eventTopicsPost(EventTopicSchemaCreate, options)(this.axios, this.basePath);
    };
    return EventTopicsApi;
}(BaseAPI));
export { EventTopicsApi };
//# sourceMappingURL=event-topics-api.js.map