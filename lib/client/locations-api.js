...
export var LocationsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        locationsListGet: function (title, autocomplete, external_id, users_fulltext_search, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var LocationsApiFp = function (configuration) {
    return {
         ...
         */
        locationsListGet: function (title, autocomplete, external_id, users_fulltext_search, offset, limit, options) {
            var localVarAxiosArgs = LocationsApiAxiosParamCreator(configuration).locationsListGet(title, autocomplete, external_id, users_fulltext_search, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
var LocationsApi = /** @class */ (function (_super) {
     ...
     * @memberof LocationsApi
     */
    LocationsApi.prototype.locationsListGet = function (title, autocomplete, external_id, users_fulltext_search, offset, limit, options) {
