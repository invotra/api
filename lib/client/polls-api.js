...
export var PollsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        pollsListGet: function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
...
export var PollsApiFp = function (configuration) {
    return {
         ...
         */
        pollsListGet: function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
            var localVarAxiosArgs = PollsApiAxiosParamCreator(configuration).pollsListGet(author_uuid, created_date, updated_date, state, sort, order, offset, limit, options);
...
var PollsApi = /** @class */ (function (_super) {
     ...
     * @memberof PollsApi
     */
    PollsApi.prototype.pollsListGet = function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
