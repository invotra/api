...
export declare const PagesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    pagesListGet(author_uuid?: string | undefined, created_date?: string | undefined, updated_date?: string | undefined, state?: string | undefined, sort?: "timestamp_created" | "timestamp_updated" | undefined, order?: "asc" | "desc" | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20020>;
    /**
     * Delete a page.
     * @param {string} page_id The Invotra UUID of the page.
     * @param {*} [options] Override http request option.
...
export interface PagesApiInterface {
     ...
     */
    pagesListGet(author_uuid?: string, created_date?: string, updated_date?: string, state?: string, sort?: 'timestamp_created' | 'timestamp_updated', order?: 'asc' | 'desc', offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20020>;
    /**
     * Delete a page.
     * @param {string} page_id The Invotra UUID of the page.
     * @param {*} [options] Override http request option.
