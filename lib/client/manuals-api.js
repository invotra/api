...
export var ManualsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        manualsGet: function (external_id, offset, limit, options) {
...
export var ManualsApiFp = function (configuration) {
    return {
         ...
         */
        manualsGet: function (external_id, offset, limit, options) {
            var localVarAxiosArgs = ManualsApiAxiosParamCreator(configuration).manualsGet(external_id, offset, limit, options);
...
export var ManualsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        manualsGet: function (external_id, offset, limit, options) {
            return ManualsApiFp(configuration).manualsGet(external_id, offset, limit, options)(axios, basePath);
        },
        /**
         * Get a manual page, including the root manual page
         * @param {string} manual_page_id The Invotra UUID of a manual page.
...
var ManualsApi = /** @class */ (function (_super) {
     ...
     * @memberof ManualsApi
     */
    ManualsApi.prototype.manualsGet = function (external_id, offset, limit, options) {
        return ManualsApiFp(this.configuration).manualsGet(external_id, offset, limit, options)(this.axios, this.basePath);
    };
    /**
     * Get a manual page, including the root manual page
     * @param {string} manual_page_id The Invotra UUID of a manual page.
