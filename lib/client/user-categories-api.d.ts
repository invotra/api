...
export declare const UserCategoriesApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    userCategoriesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20052>;
    /**
     * Provision a new user category.
     * @param {UserCategorySchemaCreate} UserCategorySchemaCreate
     * @param {*} [options] Override http request option.
...
export declare const UserCategoriesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    userCategoriesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20052>;
    /**
     * Provision a new user category.
     * @param {UserCategorySchemaCreate} UserCategorySchemaCreate
     * @param {*} [options] Override http request option.
...
export interface UserCategoriesApiInterface {
     ...
     */
    userCategoriesListGet(name?: string, external_id?: string, status?: string, valid_parents_for?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20052>;
    /**
     * Provision a new user category.
     * @param {UserCategorySchemaCreate} UserCategorySchemaCreate
     * @param {*} [options] Override http request option.
