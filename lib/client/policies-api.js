...
export var PoliciesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        policiesListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
...
export var PoliciesApiFp = function (configuration) {
    return {
         ...
         */
        policiesListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
            var localVarAxiosArgs = PoliciesApiAxiosParamCreator(configuration).policiesListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
export var PoliciesApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        policiesListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
            return PoliciesApiFp(configuration).policiesListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options)(axios, basePath);
        },
        /**
         * Delete a policy.
         * @param {string} policy_id The Invotra UUID of the policy.
...
var PoliciesApi = /** @class */ (function (_super) {
     ...
     */
    PoliciesApi.prototype.policiesListGet = function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
        return PoliciesApiFp(this.configuration).policiesListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options)(this.axios, this.basePath);
    };
    /**
     * Delete a policy.
     * @param {string} policy_id The Invotra UUID of the policy.
