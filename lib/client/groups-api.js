...
export var GroupsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupsSearchGet: function (fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var GroupsApiFp = function (configuration) {
    return {
         ...
         */
        groupsSearchGet: function (fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options) {
            var localVarAxiosArgs = GroupsApiAxiosParamCreator(configuration).groupsSearchGet(fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
var GroupsApi = /** @class */ (function (_super) {
     ...
     * @memberof GroupsApi
     */
    GroupsApi.prototype.groupsSearchGet = function (fulltext_search, category, my_groups, external_id, sort, order, offset, limit, options) {
