...
export declare const PoliciesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    policiesListGet(author_uuid?: string | undefined, created_date?: string | undefined, updated_date?: string | undefined, external_id?: string | undefined, state?: string | undefined, sort?: "timestamp_created" | "timestamp_updated" | undefined, order?: "asc" | "desc" | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20022>;
    /**
     * Delete a policy.
     * @param {string} policy_id The Invotra UUID of the policy.
     * @param {*} [options] Override http request option.
