...
export declare const QueryCategoriesApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    queryCategoriesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20047>;
    /**
     * Provision a new query category.
     * @param {QueryCategorySchemaCreate} QueryCategorySchemaCreate
     * @param {*} [options] Override http request option.
...
export declare const QueryCategoriesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    queryCategoriesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20047>;
    /**
     * Provision a new query category.
     * @param {QueryCategorySchemaCreate} QueryCategorySchemaCreate
     * @param {*} [options] Override http request option.
...
export interface QueryCategoriesApiInterface {
     ...
     */
    queryCategoriesListGet(name?: string, external_id?: string, status?: string, valid_parents_for?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20047>;
    /**
     * Provision a new query category.
     * @param {QueryCategorySchemaCreate} QueryCategorySchemaCreate
     * @param {*} [options] Override http request option.
