...
export var ListsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        listsListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
...
export var ListsApiFp = function (configuration) {
    return {
         ...
         */
        listsListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
            var localVarAxiosArgs = ListsApiAxiosParamCreator(configuration).listsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
var ListsApi = /** @class */ (function (_super) {
     ...
     * @memberof ListsApi
     */
    ListsApi.prototype.listsListGet = function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
