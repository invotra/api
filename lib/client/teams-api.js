...
export var TeamsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        teamsListGet: function (label, autocomplete, users_fulltext_search, external_id, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var TeamsApiFp = function (configuration) {
    return {
         ...
         */
        teamsListGet: function (label, autocomplete, users_fulltext_search, external_id, offset, limit, options) {
            var localVarAxiosArgs = TeamsApiAxiosParamCreator(configuration).teamsListGet(label, autocomplete, users_fulltext_search, external_id, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
var TeamsApi = /** @class */ (function (_super) {
     ...
     * @memberof TeamsApi
     */
    TeamsApi.prototype.teamsListGet = function (label, autocomplete, users_fulltext_search, external_id, offset, limit, options) {
