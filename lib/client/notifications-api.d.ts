...
export declare const NotificationsApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    notificationsGet(app_notifications_only?: boolean | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20053>;
    /**
     * Mark a notification as read.
     * @param {string} notification_id The Invotra UUID of the notification.
     * @param {*} [options] Override http request option.
...
export declare const NotificationsApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    notificationsGet(app_notifications_only?: boolean | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20053>;
    /**
     * Mark a notification as read.
     * @param {string} notification_id The Invotra UUID of the notification.
     * @param {*} [options] Override http request option.
...
export interface NotificationsApiInterface {
     ...
     * @memberof NotificationsApiInterface
     */
    notificationsGet(app_notifications_only?: boolean, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20053>;
    /**
     * Mark a notification as read.
     * @param {string} notification_id The Invotra UUID of the notification.
     * @param {*} [options] Override http request option.
