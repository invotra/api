...
export var NewsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @param {string} [state] Filter the list of news on a comma-separated list of states. Valid statuses are \&quot;draft\&quot;, \&quot;needs_review\&quot;, \&quot;reviewed\&quot;, \&quot;published\&quot;, and \&quot;unpublished\&quot;. You may include multiple. The default when not supplied is \&quot;published\&quot; only.
         ...
         */
        newsListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
...
export var NewsApiFp = function (configuration) {
    return {
         ...
         */
        newsListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
            var localVarAxiosArgs = NewsApiAxiosParamCreator(configuration).newsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options);
...
export var NewsApiFactory = function (configuration, basePath, axios) {
    return {
         ...
         */
        newsListGet: function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
            return NewsApiFp(configuration).newsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options)(axios, basePath);
        },
        /**
         * Delete a news.
         * @param {string} news_id The Invotra UUID of the news.
...
var NewsApi = /** @class */ (function (_super) {
     ...
     * @memberof NewsApi
     */
    NewsApi.prototype.newsListGet = function (author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options) {
        return NewsApiFp(this.configuration).newsListGet(author_uuid, created_date, updated_date, external_id, state, sort, order, offset, limit, options)(this.axios, this.basePath);
    };
    /**
     * Delete a news.
     * @param {string} news_id The Invotra UUID of the news.
