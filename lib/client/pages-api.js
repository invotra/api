...
export var PagesApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        pagesListGet: function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
...
export var PagesApiFp = function (configuration) {
    return {
         ...
         */
        pagesListGet: function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
            var localVarAxiosArgs = PagesApiAxiosParamCreator(configuration).pagesListGet(author_uuid, created_date, updated_date, state, sort, order, offset, limit, options);
...
var PagesApi = /** @class */ (function (_super) {
     ...
     * @memberof PagesApi
     */
    PagesApi.prototype.pagesListGet = function (author_uuid, created_date, updated_date, state, sort, order, offset, limit, options) {
