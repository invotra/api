...
export declare const MessageTypesApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    messageTypesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): (axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<InlineResponse20041>;
    /**
     * Delete a message type.
     * @param {string} message_type_id The Invotra UUID of the message type.
     * @param {*} [options] Override http request option.
...
export declare const MessageTypesApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
     ...
     * @throws {RequiredError}
     */
    messageTypesListGet(name?: string | undefined, external_id?: string | undefined, status?: string | undefined, valid_parents_for?: string | undefined, offset?: number | undefined, limit?: number | undefined, options?: any): AxiosPromise<InlineResponse20041>;
    /**
     * Delete a message type.
     * @param {string} message_type_id The Invotra UUID of the message type.
     * @param {*} [options] Override http request option.
...
export interface MessageTypesApiInterface {
     ...
     */
    messageTypesListGet(name?: string, external_id?: string, status?: string, valid_parents_for?: string, offset?: number, limit?: number, options?: any): AxiosPromise<InlineResponse20041>;
    /**
     * Delete a message type.
     * @param {string} message_type_id The Invotra UUID of the message type.
     * @param {*} [options] Override http request option.
