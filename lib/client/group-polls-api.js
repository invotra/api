...
export var GroupPollsApiAxiosParamCreator = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        groupPollsListGet: function (author_uuid, group_uuid, created_date, updated_date, sort, order, offset, limit, options) {
            if (options === void 0) { options = {}; }
...
export var GroupPollsApiFp = function (configuration) {
    return {
         ...
         */
        groupPollsListGet: function (author_uuid, group_uuid, created_date, updated_date, sort, order, offset, limit, options) {
            var localVarAxiosArgs = GroupPollsApiAxiosParamCreator(configuration).groupPollsListGet(author_uuid, group_uuid, created_date, updated_date, sort, order, offset, limit, options);
            return function (axios, basePath) {
                if (axios === void 0) { axios = globalAxios; }
                if (basePath === void 0) { basePath = BASE_PATH; }
                var axiosRequestArgs = __assign(__assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
...
var GroupPollsApi = /** @class */ (function (_super) {
     ...
     * @memberof GroupPollsApi
     */
    GroupPollsApi.prototype.groupPollsListGet = function (author_uuid, group_uuid, created_date, updated_date, sort, order, offset, limit, options) {
